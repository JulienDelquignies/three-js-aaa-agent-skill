...
- LIVRÉ (note 373, reference/51-motion-strike § B3, verify-tete-armee 6/0) : LA TÊTE ARMÉE (B3) — cfg.tete.armee : le vol est déterministe,
...
- LIVRÉ (note 380, reference/52 § A7 ter, verify-foulee 81/0) : LA FOULÉE A7 ter (§ 6) — le pas croisé du virage serré (> 7 m/s², > 3 m/s :
...
dégagement qui respire + bloc de champ + ancre à la craie.

LE BLOC DE CHAMP (176, note 216) : le ballon rapide et bas qui percute un corps
adverse DÉVIE (13 % des tirs contrés + les dégagements bloqués ; le tir fantôme
d'hier traversait). Restes du front sorties : les touches (5 c. 13/30 min), la
part de contres → corners à observer au fil du jalon densité FM.
...
poser, tenue calme 1,5/0,5, barre d'adoption 1,3/0,7), tous identité ×1 à 0,5
(les paires somment à 2). Passes 0→1 : +12,7 % (réel 15-20 %). Restent : le banc
incarné (Loi 3), les pénos absents (Lois 12/14), throwInStyle/setPiecesFocus,
la preuve de flux de commandF, la récupération haute.
...
(+31 %). La séparation des pouvoirs : l'axe pressing = le choix du coach, la note
= la qualité d'exécution. Reste : le bloc qui monte UNI pendant la fenêtre, la
33e note (trio gardien command/oneOnOnes/aerialReach).
...
Reste : command/oneOnOnes/aerialReach (gardien) + throwInStyle/setPiecesFocus.
