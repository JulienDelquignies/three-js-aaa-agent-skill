...
- Empreintes défaut : 262 (HEAD 8835e33) = `405d2e80b6d82e19 / 7ddbeaefea413442` (= 261 : la croyance a un jumeau exact) — Défaut du 277 (HEAD 59404a4 = 278 : `ellipse: null`) : `1dd69b0ccdc50f84 / 4c01c6cef91ccde2`. Défaut du 278 (HEAD 842c118 = 279 : `repertoire: null, arretControle: null`) : `1dd69b0ccdc50f84 / b8b500c9aecf89ce`.
...
## L'ordre après le 279 (PLAN_DOCTRINE, la carte du book)
...
275 (bloc-percu.js), le 276 (enveloppe.js), le 277 (visee.js), le 278 (ellipse.js) et le 279 (repertoire.js) sont scellés (la
fusion du 15/09 entre le 276 et le 277) → le volume des tirs (42 pour 25 : les entrées dans la surface, le bloc) ; la sélection du
geste par P_but (Modèle 10 §3.2) ; les montants (la collision poteau / barre, Modèle 03 §6.3) → k_x à deux régimes et le coulissement par ligne (Bible 10 §3.4, lot 2) → le ballon qui sort ;
