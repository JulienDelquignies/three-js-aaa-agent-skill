...
## L'ordre après le 284 (PLAN_DOCTRINE, la carte du book)
...
la cérémonie sautable, la touche rapide et la touche au pied ; reste l'ATTENTE VIVANTE (91 % des joueurs de champ figés pendant les
attentes : les petits déplacements, les appels des deux dernières secondes, le mur qui se pose) et le jouer-au-bon-moment ;
