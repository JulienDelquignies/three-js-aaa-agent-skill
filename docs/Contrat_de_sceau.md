...
## L'ordre après le 281 (PLAN_DOCTRINE, la carte du book)
...
la ligne accrochée) et le 281 (rendezvous.js, les postes de la remise — les trois retours du 16/09) sont scellés (les fusions du
15/09 et du 16/09 avec la branche animations) → la porte du tir dans la surface (0,5 tir par touche
