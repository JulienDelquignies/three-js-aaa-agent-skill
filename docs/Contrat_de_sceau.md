...
## L'ordre après le 277 (PLAN_DOCTRINE, la carte du book)
...
275 (bloc-percu.js), le 276 (enveloppe.js) et le 277 (visee.js) sont scellés (la fusion du 15/09 entre les deux) → la dispersion
du 258 recalibrée sur le point visé (cadrés 45 % pour 33, au-dessus 0 pour 1,5×) et le volume des tirs (42-46 pour 25 : les
entrées dans la surface, le bloc) → k_x à deux régimes et le coulissement par ligne (Bible 10 §3.4, lot 2) → le ballon qui sort ;
