...
*Fiche du 9/09, moteur fbc9369 (SCEAU 256). Mesures : 4 × 600 s à dt 1/60 et 1/30 (graines 3, 7, 11, 13).*
...
**Partiel.** Le pas est **un seul pas** (décision, locomotion, ballon au même 60 Hz — pas de Δt_dec distinct) ; la
...
seuils de frames) — d'où l'échec du test 3.
...
| 3 insensibilité au pas | D_KS < 0,03, moyenne < 5 % | mesurable, **réfuté** | dt 1/60 : **40,5 tirs / 90**, 1 465 passes, possession p50 0,43 s ; dt 1/30 : **22,5 tirs**, 1 449 passes, p50 0,43 ; D_KS(possession) **0,173** — les tirs dépendent du pas |
...
| 9 budget CPU | p50 < 40 µs, p99 < 120 | mesurable, **réfuté** | p50 **251 µs**, p99 **2 492 µs** (60 Hz : 130 s par match) |
...
1. **Le pas de décision séparé du pas physique** (test 3) : Δt_dec 0,10 s, K sous-pas ballon, et l'inventaire des
   ...
   ment sur la précision de tout ce qu'il mesure.
