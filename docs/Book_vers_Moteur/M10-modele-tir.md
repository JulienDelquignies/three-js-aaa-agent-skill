...
| cibles | 25,3 tirs ; 64 % dedans ; p50 16 m ; cadrés 33 ; contrés 27,5 ; buts / tirs 0,11 ; 2,85 buts | **278** | **42-45** tirs (25,3 — le volume reste l'affaire du bloc) ; **70-79 %** dedans ; p50 **12,2-13,5 m** ; cadrés **32-37** (33 ✓ — l'ellipse) ; hors cadre 52-55 (36-38 : les tirs absorbés sans événement comptent hors) ; contrés **11-13** ; buts / tirs **0,11-0,13** ; **5,25** buts (2,85 : le volume × 0,12) |
