...
| 3 causes d'échec | causes-passe 46-57 %, contrôle 9-13, blocages 10-12, hors-jeu 4-6 | **mesuré au 289** (sonde-289, la règle § 7.2 sur la trajectoire contrefactuelle) : causes-passe 20-25 %, contrôle raté 2-4 %, bloquées 6-8 % des pertes (4-5 % de toutes les passes, cible 3,12), hors-jeu ~1 % — les pertes hors passe (piques, conduites échappées) écrasent le tableau : 250 pertes par équipe pour 110-140 ; la pression lue (289) ôte 13 piques par équipe |
| 3 bis contrôle raté nominal | 2-4 % | à instrumenter |
| 4 sous-dosage | 60-70 % trop courtes | **mesuré au 289** : ratées non bloquées courtes 0-9 %, larges ~90 % — absent (la dispersion est angulaire, la vitesse exacte) |
