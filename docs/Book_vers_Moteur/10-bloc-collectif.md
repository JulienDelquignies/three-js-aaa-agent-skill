...
3 bis. **Le coulissement longitudinal à deux régimes** (test 18, § 3.4) — **SCELLÉ 392 (280, ligne.js)** : x_ligne = min(consigne, x_ballon − marge), la consigne par l'axe hauteurBloc (22 → 52) ± piege, la marge signée par l'état du porteur × (2 − anticipF). Mesuré : touches en surface adverse 76 → 59 / match, tirs 41,7 → 39,4, buts 6,25 → 5,6.
