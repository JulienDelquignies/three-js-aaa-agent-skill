...
| **Generated strikes (motion-rig + motion-strike + motion-cast): anatomical joint curves → animkit specs, rig profile with sign probe, per-player style, the contact sheet** | [reference/51-motion-strike.md](reference/51-motion-strike.md) |
