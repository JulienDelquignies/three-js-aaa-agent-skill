...
| **Generated gestures (motion-rig + motion-strike + motion-control + motion-aerial + motion-cast): 20 species — strikes, controls, headers — as anatomical joint curves → animkit specs, rig profile with sign probe, per-player style, the contact sheet** | [reference/51-motion-strike.md](reference/51-motion-strike.md) |
