...
import { BALL } from './ball.js'; import { laneClearance, predictPath, interceptPoint, etaCourse } from './ball-predict.js'; import { cibleFoulee, cibleAlignee } from './foulee.js'; import { elanConduite } from './elan-conduite.js'; import { suiviAppelStep } from './suivi-appel.js'; import { repliPasseStep } from './repli-passe.js'; import { repliStep } from './repli.js'; import { lossReactStep, contrePressStep } from './contrepress.js'; import { compenserLateral } from './compensation.js'; import { projeterMilieux, postesEntreLignes } from './projection.js'; import { couvertStep } from './couvert.js'; import { gardeDist } from './garde.js'; import { salidaStep, conduccion } from './salida.js'; import { cfSpots, remiseCible, sortieBalle } from './cpa.js'; import { affecterMarquage, refermerLigne , bandeDuCentral, remettreAuPivot, hommeRemis, purgerPassation } from './marquage.js'; import { RONDO, makeRondo, evadeSpot, gapZ } from './rondo.js';
...
function assignMatchJobs(st, cfg) {
  ...
  boxCrashStep(st, cfg, { busy, tac, axe, role, d2 }); contreZonesStep(st, cfg, { tac, axe, role }); suiviAppelStep(st, cfg, { tac, axe, busy }); repliPasseStep(st, cfg, { tac, axe, busy });   /* (317) l'appel en profondeur est pris — suivi-appel.js */   // 242 : les trois zones d'entrée en contre (phases.js) ; 123/182b : la géométrie du centre remplit la boîte ET les corps ATTAQUENT le vol (phases.js)
