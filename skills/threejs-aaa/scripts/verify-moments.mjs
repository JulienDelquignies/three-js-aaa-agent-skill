...
// ---------- 2. l'horloge du regain vit dans le match (événements + dérivation cohérents)
{
  ...
  const cfg = matchCfg({ ouverture: null /* ouverture null DATÉ 288 : vert à HEAD~ (worktree d90101b), 27 lectures de miroirs en flux dans ce monde (0 ✗ au 287) — la clause mesure sa loi, pas le receveur qui s'ouvre au ballon */, layoff: null /* layoff null DATÉ 287 : vert à HEAD~ (worktree 4535d0f), 25 lectures de miroirs en flux dans ce monde (8/0 au 286) — la clause mesure sa loi, pas la une-touche jugée par son angle */, ceremonie: null, ramasseurs: null, boiterie: null, entrant: null, petitsGestes: null, passements: null, enchainement: null, orientationPasse: null, verticalite: null, decalage: null, toucheOrientee: null,  shotRange: 20 });
