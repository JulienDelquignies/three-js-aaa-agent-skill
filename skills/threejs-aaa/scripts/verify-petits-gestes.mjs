...
const PINS = { ceremonie: null, ramasseurs: null, boiterie: null, entrant: null, orientationPasse: null, verticalite: null, decalage: null, receveurOuvert: null };   // (DATÉ 17/09) les quatre clés de la relecture du match nulles : ce banc mesure les petits gestes seuls
