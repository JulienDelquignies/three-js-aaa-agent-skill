...
const PINS = { ceremonie: null, ramasseurs: null, boiterie: null, entrant: null };
...
};
{
  ...
  const n = sortie({ petitsGestes: null, passements: null });
...
};
{
  ...
  const n = coupFranc({ petitsGestes: null, passements: null });
...
{
  const r = centre({}), n = centre({ petitsGestes: null, passements: null });
...
};
{
  ...
  const n = match({ petitsGestes: null, passements: null }, 60);
