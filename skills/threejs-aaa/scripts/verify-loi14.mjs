...
for (const seed of [3, 7]) {
  const { photo, evs } = penaltyWorld(seed, matchCfg({ ceremonie: null, ramasseurs: null, boiterie: null, entrant: null, petitsGestes: null,  shotRange: 20 }));
...
{
  const { photo } = penaltyWorld(3, matchCfg({ ceremonie: null, ramasseurs: null, boiterie: null, entrant: null, petitsGestes: null,  shotRange: 20, loi14: false }));
