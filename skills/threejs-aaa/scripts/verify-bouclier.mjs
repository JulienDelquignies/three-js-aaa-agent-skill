...
const tenue = (over, { dP = 0.9, secs = 4, appuiAt = null, lacheAt = null, seed = 3 } = {}) => {
  const st = makeMatch({ full: true, seed }); const cfg = matchCfg({ ceremonie: null, ramasseurs: null,  repli: false, ...over });
...
const cfg = matchCfg({ ceremonie: null, ramasseurs: null, }), K = cfg.bouclier;
