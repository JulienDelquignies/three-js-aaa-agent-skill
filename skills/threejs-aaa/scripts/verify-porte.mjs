...
const monde = (over) => {
  const cfg = matchCfg({ sortieAerienne: null, retournee: null, bouclier: null, ceremonie: null, ramasseurs: null, boiterie: null, entrant: null, petitsGestes: null,  ligne: null /* ligne null DATÉ 273 : vert à HEAD~ (4/0 au 272), les refus au contact remangés (37 c. 40) : la ligne tenue change les portés — la clause mesure sa loi, pas la ligne */, locomoteur: null /* locomoteur null DATÉ 260 : vert à HEAD~ (au 254), le porté qui anticipe remangé par le profil locomoteur (les corps démarrent en 2,3 τ) — la clause mesure le porté, pas la locomotion */, shotRange: 20, chrono: { periodes: 2, duree: 180, pause: 6 }, contre: null /* contre null DATÉ 258b : vert à HEAD~ (porte 4/0 au 258), les refus au contact (25 c. 58 = 43 % > 35) remangés par le corps qui contre — la clause mesure le porté, pas le contre */, ...over });
