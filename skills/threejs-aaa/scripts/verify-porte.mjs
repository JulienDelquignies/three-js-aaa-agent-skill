...
const monde = (over) => {
  const cfg = matchCfg({ layoff: null /* layoff null DATÉ 287 : vert à HEAD~ (worktree 4535d0f), la clé absente rend 37 refus au contact < 40 (0 ✗ au 286) — la clause mesure sa loi, pas la une-touche jugée par son angle */, attenteVivante: null /* attenteVivante null DATÉ 285 : vert à HEAD~ (worktree 3d79d38), le porté qui anticipe remangé (16 refus au contact c. 32 sans la clé pour ≤ 35 %, 32 sans pour ≥ 40) — la clause mesure sa loi, pas l'attente vivante */, sortieAerienne: null, retournee: null, bouclier: null, ceremonie: null, ramasseurs: null, boiterie: null, entrant: null, petitsGestes: null, passements: null, enchainement: null, orientationPasse: null, verticalite: null, decalage: null, toucheOrientee: null,  ligne: null /* ligne null DATÉ 273 : vert à HEAD~ (4/0 au 272), les refus au contact remangés (37 c. 40) : la ligne tenue change les portés — la clause mesure sa loi, pas la ligne */, locomoteur: null /* locomoteur null DATÉ 260 : vert à HEAD~ (au 254), le porté qui anticipe remangé par le profil locomoteur (les corps démarrent en 2,3 τ) — la clause mesure le porté, pas la locomotion */, shotRange: 20, chrono: { periodes: 2, duree: 180, pause: 6 }, contre: null /* contre null DATÉ 258b : vert à HEAD~ (porte 4/0 au 258), les refus au contact (25 c. 58 = 43 % > 35) remangés par le corps qui contre — la clause mesure le porté, pas le contre */, ...over });
