...
const match = (over, seeds = [3, 7, 11, 15], secs = 300) => {   // 4 graines : à 2 la variance des pertes noyait la clause du monde
  ...
  for (const seed of seeds) {
    const st = makeMatch({ full: true, seed }), cfg = matchCfg({ presseLue: null /* presseLue null DATÉ 289 : vert à HEAD~ (worktree 7bd70e0), les passes longues qui avancent 22 c. 21, les longs retraits 18 c. 15 dans ce monde (6/0 au 288) — la clause mesure sa loi, pas la pression lue au temps d'arrivée */, ouverture: null /* ouverture null DATÉ 288 : vert à HEAD~ (worktree d90101b), les passes longues qui avancent 21 c. 23 hier et 55 pertes pour 183 passes dans ce monde (0 ✗ au 287) — la clause mesure sa loi, pas le receveur qui s'ouvre au ballon */, layoff: null /* layoff null DATÉ 287 : vert à HEAD~ (worktree 4535d0f), les passes longues qui avancent 32 c. 30 hier et 7 tirs c. 8 dans ce monde (0 ✗ au 286) — la clause mesure sa loi, pas la une-touche jugée par son angle */, ...PINS, ...over });
