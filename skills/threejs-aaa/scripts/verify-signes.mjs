...
{
  const A = pausas({ remisePostes: null, rendezVous: null /* remisePostes et rendezVous null DATÉ 281 : vert à HEAD~ (worktree 0f5e292), la pausa au pied remangée (une des 14 pausas tient le ballon à plus de 0,6 m — la passe au rendez-vous déplace la tenue) — la clause mesure sa loi, pas la passe au rendez-vous ni les postes de la remise */ }), B = pausas({ ...SANS, ellipse: null, repertoire: null, arretControle: null, ligneAccrochee: null /* DATÉ fusion 16/09 (278-280 × A2-C3) : le garde-fou de la pausa « sans la clé » mesure le monde d'hier — sous la ligne accrochée et le répertoire, 4 pausas et 0 à l'arrêt : la combinaison remange le porteur planté, pas la loi */ });
