...
{
  const A = pausas({ layoff: null /* layoff null DATÉ 287 : vert à HEAD~ (worktree 4535d0f), la pausa tenue à 0,68 m de moyenne dans ce monde (2 à l'arrêt) — la clause mesure sa loi, pas la une-touche jugée par son angle */, remisePostes: null, rendezVous: null /* remisePostes et rendezVous null DATÉ 281 : vert à HEAD~ (worktree 0f5e292), la pausa au pied remangée (une des 14 pausas tient le ballon à plus de 0,6 m — la passe au rendez-vous déplace la tenue) — la clause mesure sa loi, pas la passe au rendez-vous ni les postes de la remise */ }), B = pausas({ ...SANS, presseLue: null /* presseLue null DATÉ 289 : vert à HEAD~ (worktree 7bd70e0), sans la clé 3 pausas, aucune à l'arrêt dans ce monde (9/0 au 288) — la clause mesure sa loi, pas la pression lue au temps d'arrivée */, attenteVivante: null /* attenteVivante null DATÉ 285 : vert à HEAD~ (worktree 3d79d38), le garde-fou « sans la clé » : 6 pausas et le ballon à 0,00 m — la combinaison remange le porteur planté, pas la loi — la clause mesure sa loi, pas l'attente vivante */, xt: null /* xt null DATÉ 283 : vert à HEAD~ (worktree bd3322e), le garde-fou « sans la clé » mesure le monde d'hier — sous la valeur de position, 8 pausas et le ballon à 0,83 m : la combinaison remange le porteur planté, pas la loi */, ellipse: null, repertoire: null, arretControle: null, ligneAccrochee: null /* DATÉ fusion 16/09 (278-280 × A2-C3) : le garde-fou de la pausa « sans la clé » mesure le monde d'hier — sous la ligne accrochée et le répertoire, 4 pausas et 0 à l'arrêt : la combinaison remange le porteur planté, pas la loi */ });
...
const attente = (over) => {
  ...
  for (const seed of [1, 2, 3, 4, 5, 6]) {
    const st = makeMatch({ full: true, seed }); const cfg = matchCfg({ ouverture: null /* ouverture null DATÉ 288 : vert à HEAD~ (worktree d90101b), le garde-fou 106 pertes c. 90 (+18 %) dans ce monde — la fragilité nommée au 284, verte au 287 (0 ✗) — la clause mesure sa loi, pas le receveur qui s'ouvre au ballon */, attenteVivante: null /* attenteVivante null DATÉ 285 : vert à HEAD~ (worktree 3d79d38), les receveurs qui attendent remangés (11,8 % c. 9,5 % + 1,5 ; les vols lents 4,1 % c. 3,0 × 1,5) — la clause mesure sa loi, pas l'attente vivante */, remisePostes: null, rendezVous: null /* remisePostes et rendezVous null DATÉ 281 : vert à HEAD~ (worktree 0f5e292), la pausa au pied et les receveurs qui attendent remangés (14 pausas à 0,51 m ; 7,8 % c. 7,3 % sans la clé) — la clause mesure sa loi, pas la passe au rendez-vous ni les postes de la remise */, enveloppe: null, blocPercu: null /* DATÉ fusion 15/09 (272-276 × A12) : vert dans son parent (9/0 à f62c3d8), le garde-fou des passes remangé par la combinaison (320 c. 248) — la clause mesure les signes du rôle, pas le gardien à l'enveloppe ni le bloc qui perçoit */, ...over }); let lastTo = null, lentCe = false, seen = 0;
...
console.log('\n— (d) le jumeau : les trois clés à null = le monde du 14/09 au bit —');
{
  ...
  const DATEES = { 1: 'f3ac39efe4d6c195', 2: '1ac0666cf6bd479f', 3: 'fe706da119b0af06' };   // REGELÉ DATÉ 291 (le tacle debout vit à chaque pique : le monde aux clés SANS nulles bouge ; la graine 3 inchangée) — 289 (la pression lue au temps d'arrivée vit chez chaque porteur : le monde aux clés SANS nulles bouge) — 288 (le receveur qui s'ouvre au ballon vit à chaque réception : le monde aux clés SANS nulles bouge) — 287 (la une-touche jugée par son angle : le monde aux clés SANS nulles bouge, la loi vit à chaque première intention) — 281 (les trois retours du 16/09) : les empreintes du monde 281 aux clés nulles — « hier » y est désormais le 281 (le point de rendez-vous des passes et les postes de la remise allumés) ; REGELÉ DATÉ fusion 16/09 (278-280 × A2-C3) : les empreintes du monde fusionné e798b47 aux clés nulles — « hier » y est désormais le 280 (ellipse, répertoire, arrêt au journal, ligne accrochée allumés) ; // REGELÉ DATÉ fusion 15/09 (272-276 × A12) : les empreintes du monde 662a444 aux trois clés nulles — « hier » est désormais le 276 (la porte xG, la ligne, l'interligne, le bloc qui perçoit, l'enveloppe) ; DATÉ 14/09 (dettes A12) : 8aa4baa7c0092cec / cecae92caa993608 / 9c8eda27f0f5dc63, le monde 3d72ea4
