...
// ---------- 6. sabotage nommé « jeu au sol » : tete:false → le vol traverse, personne ne saute
{
  ...
  const cfg0 = matchCfg({ ceremonie: null, ramasseurs: null, boiterie: null, entrant: null, petitsGestes: null, passements: null, enchainement: null,  shotRange: 20, tete: false });
