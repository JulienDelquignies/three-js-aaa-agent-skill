...
const EXPRIMES_249 = ['GK A|garde', 'GK B|garde', 'LAT B|largeurR', 'AV A|repli', 'AV B|repli', 'AV C|repli', 'MDC C|largeurR', 'LAT C|profondeur', 'DC B|largeurR', 'DC B|profondeur', 'DC C|largeurR', 'DC C|profondeur', 'LAT D|largeurR', 'MO A|press', 'MO A|tenue', 'MIL B|tenue', 'MO B|appel', 'MO C|tenue', 'AIL A|largeurR', 'AV A|largeurR', 'AV A|profondeur', 'AIL B|appel', 'AIL C|press'];   // REGELÉ DATÉ 254 (le monde de la familiarité) : perdues DC A|profondeur, LAT A|appel, LAT D|profondeur, LAT D|appel, MDC A|profondeur, MIL A|tenue, MDC B|press, MO B|profondeur, MDC C|profondeur ; gagnées DC B|largeurR, DC B|profondeur, DC C|largeurR, DC C|profondeur, LAT D|largeurR, MO A|press, MO A|tenue, MIL B|tenue, MO B|appel, MO C|tenue, AIL A|largeurR, AV A|largeurR, AV A|profondeur, AIL B|appel, AIL C|press (17 → 23 signatures — la dette de volumétrie à 6 graines demeure)
