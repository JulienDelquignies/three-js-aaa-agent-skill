...
const EXPRIMES_249 = ['GK A|garde', 'GK B|garde', 'LAT B|largeurR', 'MO A|press', 'AV A|repli', 'AV B|repli', 'AV C|repli', 'AIL C|repli', 'MDC A|largeurR', 'MDC B|profondeur', 'MO A|tenue', 'MDC B|appel', 'MDC C|largeurR', 'MDC C|appel', 'AIL A|largeurR', 'AV A|largeurR', 'DC B|profondeur', 'DC C|appel', 'MDC A|appel'];   // REGELÉ DATÉ 253 (le monde de la pausa) : perdue DC A|profondeur ; gagnées DC B|profondeur, DC C|appel, MDC A|appel (17 → 19 signatures — la dette de volumétrie à 6 graines demeure)
