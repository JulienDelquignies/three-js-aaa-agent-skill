...
const EXPRIMES_249 = ['GK A|garde', 'DC A|largeurR', 'DC A|profondeur', 'DC A|press', 'LAT A|profondeur', 'GK B|garde', 'DC B|profondeur', 'LAT B|largeurR', 'DC C|largeurR', 'DC C|profondeur', 'LAT C|profondeur', 'LAT C|appel', 'LAT D|profondeur', 'MIL A|tenue', 'MO A|press', 'MO B|profondeur', 'AV A|profondeur', 'AV A|repli', 'AIL B|appel', 'AV B|repli', 'AIL C|repli', 'AV C|repli', 'AIL D|largeurR'];   // REGELÉ DATÉ 264 (le monde des flux nommés : un autre tirage de la même distribution — la liste bouge sans qu'aucune loi de rôle n'ait changé, la preuve que 6 graines sont trop peu) : 17 → 23 signatures — perdues LAT D|largeurR, MIL B|tenue, AIL C|largeurR, AV C|tenue ; gagnées GK B|garde, DC B|profondeur, DC C|largeurR, DC C|profondeur, LAT C|profondeur, MIL A|tenue, AV A|profondeur, AIL B|appel, AIL C|repli, AIL D|largeurR (la dette de volumétrie à 6 graines demeure)
