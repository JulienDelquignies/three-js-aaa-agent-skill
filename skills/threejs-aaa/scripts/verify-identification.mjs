...
const EXPRIMES_249 = ['GK A|garde', 'GK B|garde', 'LAT B|largeurR', 'MO A|press', 'AV A|repli', 'AV B|repli', 'AV C|repli', 'AIL C|repli', 'DC A|profondeur', 'MDC A|largeurR', 'MDC B|profondeur', 'MO A|tenue', 'MDC B|appel', 'MDC C|largeurR', 'MDC C|appel', 'AIL A|largeurR', 'AV A|largeurR'];   // REGELÉ DATÉ 259 (le monde de l'orteil et de la course qui traverse, moteur final du sceau) : perdues depuis le 257 DC B|profondeur, LAT C|appel, LAT D|largeurR, LAT D|profondeur, LAT A|appel, LAT D|appel ; gagnées MDC B|profondeur, MO A|tenue, MDC B|appel, MDC C|largeurR, MDC C|appel, AIL A|largeurR, AV A|largeurR (16 → 17 signatures — la dette de volumétrie à 6 graines demeure)
