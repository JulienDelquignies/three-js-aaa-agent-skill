...
const EXPRIMES_249 = ['GK A|garde', 'DC A|profondeur', 'GK B|garde', 'DC B|profondeur', 'LAT D|largeurR', 'MO A|press', 'MO A|tenue', 'MIL C|repli', 'AV A|profondeur', 'AV A|repli', 'AV B|repli', 'AIL C|repli', 'AV C|repli', 'AV C|tenue'];   // REGELÉ DATÉ 291 (19 → 14, le tacle debout : le monde bouge) — REGELÉ DATÉ 289 (16 → 19 ; la plage des lots 280-288 est 10-24 : 6 × 240 s ne tiennent pas 5/6 de concordance quand le monde bouge)
