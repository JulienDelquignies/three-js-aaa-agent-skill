...
const EXPRIMES_249 = ['GK A|garde', 'DC A|largeurR', 'GK B|garde', 'LAT B|largeurR', 'LAT C|appel', 'MO A|press', 'AV A|profondeur', 'AV A|repli', 'AV B|repli', 'AV C|repli', 'AIL D|largeurR'];   // REGELÉ DATÉ 287 (21 → 11 ; la plage des lots 280-286 est 10-24 : 6 × 240 s ne tiennent pas 5/6 de concordance quand le monde bouge)
