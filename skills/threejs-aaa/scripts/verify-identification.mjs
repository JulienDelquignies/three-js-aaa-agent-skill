...
const EXPRIMES_249 = ['GK A|garde', 'GK B|garde', 'DC B|profondeur', 'LAT B|largeurR', 'LAT C|appel', 'LAT D|largeurR', 'LAT D|profondeur', 'MO A|press', 'AV A|repli', 'AV B|repli', 'AV C|repli', 'LAT A|appel', 'LAT D|appel', 'AIL C|repli', 'DC A|profondeur', 'MDC A|largeurR'];   // REGELÉ DATÉ 257 (le monde du carton qui juge la nature) : perdues LAT A|profondeur, MDC A|profondeur, AV A|press, AV C|tenue ; gagnées DC A|profondeur, MDC A|largeurR (18 → 16 signatures — la dette de volumétrie à 6 graines demeure : les pertes et gains oscillent entre les mêmes signatures d'un monde à l'autre)
