...
const EXPRIMES_249 = ['GK A|garde', 'GK B|garde', 'LAT B|largeurR', 'AV A|repli', 'AV B|repli', 'AV C|repli', 'MDC C|largeurR', 'DC A|profondeur', 'LAT A|appel', 'LAT C|profondeur', 'LAT D|profondeur', 'LAT D|appel', 'MDC A|profondeur', 'MIL A|tenue', 'MDC B|press', 'MO B|profondeur', 'MDC C|profondeur'];   // REGELÉ DATÉ 255 (le monde de la ligne synchrone) : perdues MO A|press, AIL C|repli, MDC A|largeurR, MDC B|profondeur, MO A|tenue, MDC B|appel, MDC C|appel, AIL A|largeurR, AV A|largeurR, DC B|profondeur, DC C|appel, MDC A|appel ; gagnées DC A|profondeur, LAT A|appel, LAT C|profondeur, LAT D|profondeur, LAT D|appel, MDC A|profondeur, MIL A|tenue, MDC B|press, MO B|profondeur, MDC C|profondeur (19 → 17 signatures — la dette de volumétrie à 6 graines demeure)
