...
// ---------- 5. le FLUX : l'orientation du jeu a changé, le jeu respire
{
  ...
  // (le patron : les bornes absolues morphent, les effets nets restent).
  {
    ...
    const ax99 = (over) => {
      ...
      for (const seed of [1, 3, 5, 7]) {
        const st = makeMatch({ full: true, seed });
        const cfg = matchCfg({ tacleDebout: null /* tacleDebout null DATÉ 291 : vert à HEAD~ (banc du 290, d9971be), le couloir ouvert se mesure au monde d'avant le tacle debout */, presseLue: null /* presseLue null DATÉ 289 : vert à HEAD~ (worktree 7bd70e0), le couloir ouvert 39 % c. 40 saboté dans ce monde (le lot 99 vert à HEAD~ ; l'orientation reste l'héritée) — la clause mesure sa loi, pas la pression lue au temps d'arrivée */, ouverture: null /* ouverture null DATÉ 288 : vert à HEAD~ (worktree d90101b), le couloir ouvert 38 % = 38 % saboté dans ce monde (le lot 99 vert à HEAD~ ; l'orientation reste l'héritée) — la clause mesure sa loi, pas le receveur qui s'ouvre au ballon */, toucheRapide: null, toucheAuPied: null /* toucheRapide et toucheAuPied null DATÉ 284 : vert à HEAD~ (worktree 695d340), le couloir ouvert remangé (sabotage 46 % c. ≥ vif 43 + 4 : les touches au pied changent le jeu de l'aile) — la clause mesure sa loi, pas la touche rapide ni la touche au pied */, ceremonie: null, ramasseurs: null, boiterie: null, entrant: null, petitsGestes: null, passements: null, enchainement: null, orientationPasse: null, verticalite: null, decalage: null, toucheOrientee: null,  shotRange: 20, ecarte: false, conduiteCouloir: false, ...over });
