...
{
  const h = joue({ ramasseurs: null, boiterie: null, entrant: null, petitsGestes: null, passements: null, enchainement: null }, 30);   // le preneur parqué à 40 m met ~25 s à venir : on lui laisse le temps
