...
const centre = (over, { h = 1.8, regard = 'dos', foe = false, apex = 5.8 } = {}) => {
  const st = makeMatch({ full: true, seed: 3 }); const cfg = matchCfg({ ceremonie: null, ramasseurs: null, boiterie: null, entrant: null,  repli: false, ...over });
...
const tick = 1 / 60 + 1e-6, cfg = matchCfg({ ceremonie: null, ramasseurs: null, boiterie: null, entrant: null, }), R = cfg.retournee;
