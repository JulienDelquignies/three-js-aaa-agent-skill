...
const film = (seed, over = {}, note = null, dur = 240) => {
  const st = makeMatch({ full: true, seed, squads: note != null ? [eq({ scanning: note }), eq({})] : null }), cfg = matchCfg({ ellipse: null /* ellipse null DATÉ 278 : vert à HEAD~ (worktree 59404a4, 5/0), la saccade de Jordet remangée (1 violation) — la clause mesure sa loi, pas l'ellipse de finition */, enveloppe: null /* enveloppe null DATÉ 276 : vert à HEAD~ (5/0 au 275), la cadence de Jordet remangée (8 % de saccades hors ballon au bord de la bande) : l'enveloppe change les reprises — la clause mesure sa loi, pas l'enveloppe */, xg: null /* xg null DATÉ 272 : vert à HEAD~ (5/0 au 271), 1 saccade de Jordet dans le monde remangé par la porte xG — la clause mesure sa loi, pas le xG */, ballonFou: null /* ballonFou null DATÉ 271 : vert à HEAD~ (5/0 au 270), une saccade chevauche une frappe dans ce tirage du monde (1 violation de Jordet) — la clause mesure l'horloge de scan, pas le ballon fou */, selection: null /* selection null DATÉ 267 : vert à HEAD~ (5/0 au 266), une saccade chevauche une frappe dans ce tirage du monde (1 violation de Jordet) — la clause mesure l'horloge de scan, pas la sélection */, interception: null /* interception null DATÉ 266 : vert à HEAD~ (5/0 au 265), une saccade chevauche une frappe dans ce tirage du monde (1 violation de Jordet) — la clause mesure l'horloge de scan, pas l'interception */, flux: null /* flux null DATÉ 264 : vert à HEAD~ (au 263), une saccade du regard de passe (262) chevauche une frappe une-touche dans ce tirage du monde (1 violation de Jordet — dette nommée au 342 : le regard de passe doit s'éteindre à la frappe) — la clause mesure sa loi, pas le flux */, croyance: null /* croyance null DATÉ 262 : PAR DESSEIN — la couche de croyance lit la saccade (le regard de l'observateur) : sous elle, l'horloge de scan bouge des bits de jeu (le passeur vise ce qu'il a regardé) ; la clause prouve la NEUTRALITÉ de l'horloge d'hier, qui ne vaut que sans la croyance (Modèle 04 lot 2 : le scan devient la source des observations) */, locomoteur: null /* locomoteur null DATÉ 260 : vert à HEAD~ (27/0 au 254), le monde remangé par le profil locomoteur — la clause mesure l'attribut ou l'horloge, pas la locomotion */, familiarite: null /* familiarite null DATÉ 254 : vert à HEAD~ (5/0 au 255), Jordet remangé par la familiarité (1 saccade pendant une frappe) — la clause mesure l'horloge de scan, pas la familiarité */, pausa: null /* pausa null DATÉ 253 : vert à HEAD~ (5/0 en worktree 22c35d7), Jordet remangé par la pausa (1 saccade pendant une frappe — le porteur qui tient scanne) — la clause mesure l'horloge de scan, pas la pausa */, shotRange: 20, ...over });
