...
const rougeWorld = (seed) => {
  const cfg = matchCfg({ ceremonie: null, ramasseurs: null, boiterie: null, entrant: null, petitsGestes: null, passements: null,  shotRange: 20, carton: null /* carton null DATÉ 257 : le rouge de ce banc naît de la récidive du 25 ; le monde 257 juge la nature au flux */ });
