...
const centre = (over, { h = 1.9, course = 0, back = 0, apex = 5.8 } = {}) => {
  const st = makeMatch({ full: true, seed: 3 }); const cfg = matchCfg({ ceremonie: null,  repli: false, retournee: null, bouclier: null /* retournee null DATÉ 16/09 (C1, note 376) : l'attaquant posé dos au but volait la fixture en ciseau */, ...over });
...
{
  const T = matchCfg({ ceremonie: null, }).tete;
