...
const LAB = { ecarte: false, conduiteCouloir: false, ramasse: false, audace: false,
  ...
  accompagne: false, yawSlew: false, tranchant: false, pousse: false, fixe: false, oeil: false, dispersion: false, semellePlace: false, departVu: false, tacleVif: false, mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } };   // …le monde d'hier (pré-137/160)                        // …la diagonale unique et la mène myope d'hier (pré-125/128)
...
// respiration tenue). La MÊME mesure, deux mondes — le sabotage est la clé retirée.
{
  ...
  const vif = mesure({ settledNear: Infinity, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });   // …et 166/167 épinglés des DEUX côtés (le vivant montait à 10 %, l'écart net tombait à 10 pts pile)
  ...
  const fige = mesure({ meetWalk: false, chutePredite: false, settledNear: Infinity, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });   // le monde d'hier COMPLET (lot 52 : la chute prédite anime aussi — l'isolation du sabotage la coupe)
...
// remise courte d'hier aux deux distances — la faute qui ne coûte rien, nommée.
{
  ...
  const pr = prise(21, { mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } }), lo = prise(40, { mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } }), xl = prise(60, { mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });   // isolation 159/160
  const sab = prise(21, { cfDirect: false, mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } }), sabL = prise(40, { cfDirect: false, mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });
...
// en possession et la distance au plus proche coéquipier — l'hier vivait superposé (38 m).
{
  ...
  const vif = respire({ departVu: false, tacleVif: false, mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });   // la clause isole 155/157/159/160 (les re-dateurs)
  const sab = respire({ departVu: false, tacleVif: false, mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 }, soutienN: null, supportSpanFull: 0, settledNear: Infinity });
...
// ---- LOT 115 : LE PETIT PONT — le ballon À TRAVERS le glisseur, un pari aux attributs
{
  ...
  const vifP = fluxP({ tranchant: false, pousse: false, departVu: false, tacleVif: false, mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });   // la clause isole 140/141/155-160 (les fenêtres du glisseur bougent avec le monde)
...
// ---- LOT 117 : LA ROULETTE — le 360 qui protège, l'agilité filtre
{
  ...
  const vifR = fluxR({ compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });   // la clause isole 162 (les fenêtres re-datent la matière de la roulette)
  const sabR = fluxR({ compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 }, skill: { ...matchCfg().skill, rouletteFoe: null } });
...
// ---- LOT 118 : LA TALONNADE DE CHOIX — la passe arrière sans se retourner, offensive
{
  ...
  const talon = (over) => {
    ...
    for (const seed of [1, 2, 3, 4]) {
      ...
      const cfg = matchCfg({ shotRange: 20, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 }, ...over });
...
// contact, les tours ajoutés exposent le ballon calé.
{
  const dist124 = (over) => {
    ...
    for (const seed of [1, 2, 3, 4, 5, 6]) {
      const st = makeMatch({ full: true, seed });
      const cfg = matchCfg({ shotRange: 20, mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 }, ...(over ? { skill: { ...matchCfg().skill, ...over } } : {}) });   // isolation 159/160
      let cursor = 0;
      for (let i = 0; i < 300 * 60; i++) {
        matchStep(st, 1 / 60, cfg);
        for (; cursor < st.events.length; cursor++) {
...
// unique que l'utilisateur voyait) ; après : deborde 9 / underlap 5 / banane 2 sur 6 matchs.
{
  ...
  const vif5 = rep125({});
  const sab5 = rep125({ courseAilier: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });   // 167 : intervalle/croise naissent de courseServie — le sabotage du z×0,55 isole les DEUX sources d'espèces
...
// le GRAND saut attend sa tenue, le suivi fin garde sa cadence, le burst exempt).
{
  ...
  const vifD = danse({ tranchant: false, pousse: false, departVu: false, tacleVif: false, mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });   // la clause isole 140/141/155-160 (les re-dateurs de durées)
...
// les seuils d'étau au style × rôle press. Le gate : 90 tirs / 17 buts, seed 7 AU BIT du 135.
{
  ...
  const poss = sortie(['possession', 'possession'], { accompagne: false, departVu: false, tacleVif: false, mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });   // isolation 137/155-160 : sa loi seule varie
  const defo = sortie(null, { accompagne: false, departVu: false, tacleVif: false, mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });
  const sab136 = sortie(['possession', 'possession'], { accompagne: false, departVu: false, tacleVif: false, mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 }, sortieGardien: false });
...
// SA PLACE, L'ŒIL DE L'URGENCE, LE JETÉ SE PUNIT, LE HORS-CADRE (retours utilisateur ×4).
{
  ...
  const vifO = inter({ compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });   // la clause isole 162
  const sabO = inter({ compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 }, oeil: false });
  ...
  const sousPlancher = (over = {}) => {
    ...
    for (const seed of [1, 2, 3, 4, 5, 6, 7, 8]) {
      const st = makeMatch({ full: true, seed });
      const cfg = matchCfg({ ...ISO171, shotRange: 20, mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 }, ...over });   // isolation 159/160
      for (let i = 0; i < 300 * 60; i++) matchStep(st, 1 / 60, cfg);
...
// 0,5 = l'identité au bit (empreintes) ; appariés mêmes graines, l'effet est attribuable.
{
  const course = (tq) => {
    ...
    const cfg = matchCfg({ ...ISO171, shotRange: 20, departVu: false, tacleVif: false, mord: false, pressZone: false, rondSort: false, compression: false, tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });   // la clause isole 155-160 : l'axe seul varie
...
// ---- lot 166 : LE DUEL CONTESTÉ (cfg.tacleDegage — la prise n'est propre qu'à la garde)
{
  ...
  ok(`lot 166 — SANS la clé, le duel 100 % propre d'hier (dégagé ${essai(1, 0.99, { tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } })} même au tirage 0,99) ; et le dégagé LIBÈRE (phase loose, porteur -1 : ballon vivant à disputer)`,
    essai(1, 0.99, { tacleDegage: false, courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } }) === false && (() => { const st = makeMatch({ full: true, seed: 5 }); st.rnd = () => 0.99; tacleDegage(st, st.players[3], matchCfg()); return st.phase === 'loose' && st.possession.carrier === -1; })());
}
...
// court derrière un ballon, ni axe, ni diagonale, ni couloir, ni entre deux »)
{
  ...
  const V = cours({}), E = cours({ courseServie: false, lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });
...
// ---- lot 168 : LE DUEL DE LA PASSE EN PROFONDEUR (l'espace + le lecteur)
{
  ...
  const lV = lect({}), lE = lect({ lectureCourse: false, retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });
...
// des fautes de surface est SOUS LE POISSON au banc : 0 ≤ 0 ne prouvait rien, la leçon)
{
  ...
  const R = glisse(0.99), P = glisse(0.01), H = glisse(0.99, { retenueSurface: false, corpsOuvert: false, gkTenue: false, rayonsLoi: false, sortieGardien: {}, celebration: { dur: 6.5, n: 3 } });
