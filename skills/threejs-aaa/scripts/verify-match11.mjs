...
if (__bloc()) {
  ...
  ok(`lot 192 — LA ZONE ROUGE SE SERRE (prises dos-au-but : marqueur vivant p50 ${pV} m ≤ épinglé ${pE} − 0,6 — le point d'appui a un défenseur, les duels serrés doublés, tirs post-prise-marquée 33 → 21 % mesurés) ; LE DOS FERMÉ au mécanisme : avances 1 s ${aV} / ${aE} m (informatif — l'épisode posé recule des deux côtés, le juge de flux fait foi)`,
    pV <= pE - 0.6);
}
