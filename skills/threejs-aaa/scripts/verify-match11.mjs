...
if (__bloc()) {
  ...
  const sV = sorties({ allonge: false, poitrine: false, boxCrash: { couloir: 0.4, prof: 12, garde: 12 }, lance: false, gkAuDevant: false, slideTackle: { at: [1.35, 2.5], body: 1.1, speed: 4.4, carrySpeed: 4.4, trip: 0.7 } }), sE = sorties({ clearSigma: false, contreTir: false, craie: false, gkPied: false, allonge: false, poitrine: false, boxCrash: { couloir: 0.4, prof: 12, garde: 12 }, lance: false, gkAuDevant: false, slideTackle: { at: [1.35, 2.5], body: 1.1, speed: 4.4, carrySpeed: 4.4, trip: 0.7 } });   // …et 181-191 épinglés des deux côtés (le flux des sorties bouge avec eux)
...
if (__bloc()) {
  ...
  const zPostes = (roles) => {
    ...
    const cfg = matchCfg({ shotRange: 20, moities: false, retourTrot: false, lance: false, gkAuDevant: false, slideTackle: { at: [1.35, 2.5], body: 1.1, speed: 4.4, carrySpeed: 4.4, trip: 0.7 } });   // la clause mesure l'HÉRITAGE — elle isole 183-191 (l'engagement, le lancé, le gardien sorti et le tacle re-dataient les possessions du poste)
    const z = {};
    for (let i = 0; i < 150 * 60; i++) {
      matchStep(st, 1 / 60, cfg);
