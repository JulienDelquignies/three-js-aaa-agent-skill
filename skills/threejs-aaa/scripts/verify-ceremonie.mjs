...
const joue = (over, secs, seed = 3) => {
  const st = makeMatch({ full: true, seed }); const cfg = matchCfg({ chrono: { periodes: 1, duree: 40, pause: 4 }, temps: { ...T0, additionnel: { ...T0.additionnel, min: 0 } }, petitsGestes: null, passements: null, enchainement: null, orientationPasse: null, verticalite: null, decalage: null, toucheOrientee: null /* DATÉ 16/09 (§ 10) */, ...over });
...
{
  const h = joue({ ceremonie: null, ramasseurs: null, boiterie: null, entrant: null, petitsGestes: null, passements: null, enchainement: null, orientationPasse: null, verticalite: null, decalage: null, toucheOrientee: null }, 50);
