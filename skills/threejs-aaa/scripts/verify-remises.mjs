...
// 'relance-main' n'est jamais tombé en 7 graines × 240 s : la clause force la distribution via beginPass).
{
  ...
  {
    const cfg0 = matchCfg({ ceremonie: null,  ligne: null /* ligne null DATÉ 273 : vert à HEAD~ (36/0 au 272), les remises sans clé remangées (2 prises sans armé) : la ligne tenue change les corps — la clause mesure sa loi, pas la ligne */, locomoteur: null /* locomoteur null DATÉ 260 : vert à HEAD~ (au 254), la course d'élan, la prise et le lanceur remangés par le profil locomoteur (les corps démarrent en 2,3 τ) — la clause mesure la remise, pas la locomotion */, familiarite: null /* familiarite null DATÉ 254 : vert à HEAD~ (36/0 au 255), le lanceur remangé par la familiarité (bassin −0,72 m) — la clause mesure la touche, pas la familiarité */, horsJeu: null /* horsJeu null DATÉ 259 : vert à HEAD~ (36/0 en worktree 3a78940), le lanceur remangé par l'appel de l'épaule (bassin −0,34 m, face 16°) — la clause mesure la touche, pas la Loi 11 */, shotRange: 20, chrono: { periodes: 2, duree: 180, pause: 6 }, remisesMain: null });
...
{
  const cfg = matchCfg({ ceremonie: null,  locomoteur: null /* locomoteur null DATÉ 260 : vert à HEAD~ (au 254), la course d'élan, la prise et le lanceur remangés par le profil locomoteur (les corps démarrent en 2,3 τ) — la clause mesure la remise, pas la locomotion */, familiarite: null /* familiarite null DATÉ 254 : vert à HEAD~ (36/0 au 255), le lanceur remangé par la familiarité (bassin −0,72 m) — la clause mesure la touche, pas la familiarité */, horsJeu: null /* horsJeu null DATÉ 259 : vert à HEAD~ (36/0 en worktree 3a78940), le lanceur remangé par l'appel de l'épaule (bassin −0,34 m, face 16°) — la clause mesure la touche, pas la Loi 11 */, shotRange: 20, chrono: { periodes: 2, duree: 180, pause: 6 } });
  ...
  {
    const cfg0 = matchCfg({ ceremonie: null,  ligne: null /* ligne null DATÉ 273 : vert à HEAD~ (36/0 au 272), les remises au pied sans clé remangées (2 prises sans armé, coup-franc-direct) : la ligne tenue change les corps — la clause mesure sa loi, pas la ligne */, locomoteur: null /* locomoteur null DATÉ 260 : vert à HEAD~ (au 254), la course d'élan, la prise et le lanceur remangés par le profil locomoteur (les corps démarrent en 2,3 τ) — la clause mesure la remise, pas la locomotion */, familiarite: null /* familiarite null DATÉ 254 : vert à HEAD~ (36/0 au 255), le lanceur remangé par la familiarité (bassin −0,72 m) — la clause mesure la touche, pas la familiarité */, horsJeu: null /* horsJeu null DATÉ 259 : vert à HEAD~ (36/0 en worktree 3a78940), le lanceur remangé par l'appel de l'épaule (bassin −0,34 m, face 16°) — la clause mesure la touche, pas la Loi 11 */, shotRange: 20, chrono: { periodes: 2, duree: 180, pause: 6 }, remisesPied: null });
  ...
  {
    const mesure = (over) => {
      const cfgC = matchCfg({ ceremonie: null,  ...over }); let { st } = playMatch(makeMatch({ full: true, seed: 7 }), 8, { cfg: cfgC });
    ...
    const RPh = matchCfg({ ceremonie: null, }).remisesPied;
...
{
  const cfg = matchCfg({ ceremonie: null, });
  const hyp = Math.hypot;
  ...
  {
    const RP = cfg.remisesPied, cfg0 = matchCfg({ ceremonie: null,  remisesPied: { elan: { ...RP.elan, sortieBut: null, toucheLongue: null }, volee: RP.volee, touche: RP.touche, mur: null } });
