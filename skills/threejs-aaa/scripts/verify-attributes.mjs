  ...
  // porte de discipline du 95 juge (balPrenable), et l'horloge est À LA NOTE tackling.
  {
    ...
    const armes = (over, note) => {
      ...
      for (const seed of [2, 3, 5, 8, 9, 11]) {
        ...
        const cfg = matchCfg({ shotRange: 20, hommeLibre: false, qualiteTir: false, contrePress: false, referme: false, avantContact: false, relance: false, remise: false, cpaMontee: false, dribble: false, foulee: false, repli: false, garde: false, ...over });
        for (let i = 0; i < 300 * 60; i++) matchStep(st, 1 / 60, cfg);
