...
const cfgD = () => matchCfg({ ceremonie: null, ramasseurs: null,  shotRange: 20 });
...
}
{
  ...
  const a = arbitre(st, c, matchCfg({ ceremonie: null, ramasseurs: null,  shotRange: 20, menace: { tir: 1, centre: 0, passe: 0, conduite: 0 } }));
