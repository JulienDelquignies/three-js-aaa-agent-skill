...
const cfgD = () => matchCfg({ ceremonie: null, ramasseurs: null, boiterie: null, entrant: null, petitsGestes: null, passements: null, enchainement: null, orientationPasse: null, verticalite: null, decalage: null, toucheOrientee: null,  shotRange: 20 });
...
}
{
  ...
  const a = arbitre(st, c, matchCfg({ ceremonie: null, ramasseurs: null, boiterie: null, entrant: null, petitsGestes: null, passements: null, enchainement: null, orientationPasse: null, verticalite: null, decalage: null, toucheOrientee: null,  shotRange: 20, menace: { tir: 1, centre: 0, passe: 0, conduite: 0 } }));
...
// ---------- 4. le flux : l'arbitre vit, se répartit, et l'angle fermé n'est PLUS TENTÉ
{
  ...
  for (const seed of [4, 1, 2, 3, 5, 6, 7, 8]) {   // 5 → 8 graines DATÉ A10 (4 changements d'avis pour ≥ 5 au max des graines dans le monde du contact — un compte à un chiffre)
    ...
    const cfg = { ...cfgD(), xt: null /* xt null DATÉ 283 : vert à HEAD~ (worktree bd3322e), 12 tentatives d'angle fermé apparaissent dans ce tirage du monde sous la valeur de position — la clause mesure l'arbitre, pas la valeur de position xT */, interception: null /* interception null DATÉ 266 : vert à HEAD~ (11/0 au 265), 6 tentatives d'angle fermé apparaissent dans ce tirage du monde — la clause mesure l'arbitre, pas l'interception */, contact: null, porteAnticipe: null, remisesPied: null };   // DATÉ A10 : 4 changements d'avis au max pour ≥ 5 dans le monde du contact, à 5 comme à 8 graines — la clause lit l'arbitre d'hier
    let gel = 0;
