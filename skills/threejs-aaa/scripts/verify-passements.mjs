...
console.log('— (a) le ballon calé au point du clip —');
{
  ...
  const n = faceAFace({ passements: null, enchainement: null });
...
console.log('— (b) il fixe son vis-à-vis —');
{
  ...
  const n = faceAFace({ passements: null, enchainement: null }, { bear: 85, d: 1.9 });
...
console.log('— (c) le match nourri —');
{
  ...
  const a = compte({}), n = compte({ passements: null, enchainement: null });
