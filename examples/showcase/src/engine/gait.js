 ...
 * (vérifiée dans le texte du PDF) : 3,52 m/s → 1,31 Hz (S 2,62 m) ; 5,2 → 1,47 (3,42) ; 7,0 → 1,75
 * (3,99) ; 8,95 → 2,18 (4,10). SOUS 3,52 m/s la table s'arrête : la course lente prolonge la pente de
 * Dorn entre ses deux premières vitesses (0,095 Hz par m/s) jusqu'à la transition marche-course, 2,1 m/s
 * → 1,175 Hz (EXTRAPOLÉ, marqué comme tel). Au-delà de 8,95 : la dernière valeur (la table s'arrête).
 */
export const DORN_2012 = [[3.52, 1.31, 0.243], [5.2, 1.47, 0.188], [7.0, 1.75, 0.145], [8.95, 2.18, 0.118]];   // [v m/s, f Hz, contact s]
const LAW = [[0, 0], [1.4, 0.93], [2.1, 1.175], ...DORN_2012.map(([v, f]) => [v, f])];
