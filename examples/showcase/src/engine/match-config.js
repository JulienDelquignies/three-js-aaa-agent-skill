...
export const MATCH = {
  ...
  loi12: { avantage: 1.8, contact: 0.9, mur: 9.15, jaune: 2, murTrot: 1.6 }, viragesLisses: { taux: 6, tau: 0.15, des: 2.0, frein: 0.2, arrivee: 1.5 }, plantVitesse: true, sortieAerienne: { bas: 1.6, haut: 2.3, zone: 8, large: 3, vitesse: 5.5, reaction: 0.2, marge: 0.1, detente: 1.0, duel: 7, saut: 0.5, portee: 40 },   // (B4) murTrot : les deux hommes du mur sont les deux qui y seront les PREMIERS (les plus près du mur) et ils y TROTTENT (× marche), null : les deux plus profonds au pas — (B5) viragesLisses : le cap demandé filtré (tau s) et borné (taux/v rad/s) dès des m/s, les courbes à la place du bang-bang latéral, null : les cassures d'hier — (B6) plantVitesse : le corps planté sous un acte a une vitesse NULLE (sauf élan / tête armée / mains ; hier p.v gardait sa dernière valeur : 84 % des images plantées à > 1 m/s, l'armé de passe à 4,4 m/s p50), null : hier
