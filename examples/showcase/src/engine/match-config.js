...
export const MATCH = {
  ...
  epaule: { marge: 2, profond: 3, haut: 0.3 },   // LA POINTE SUR L'ÉPAULE (240d, match-sim) : la cible d'une pointe posée remonte à marge × axe(profondeur : décrocheur ×profond, 9 haut ×haut) m de la ligne de hors-jeu ; absente : le slot qui traîne d'hier   // LE MARQUÉ NE SE JOUE QU'EN REMISE (240a, choosePass) : sous seuil m de liberté, malus × (1 − liberté/seuil) × visionF × axe style ÷ controlF du receveur, ÷ remiseF s'il a une remise (coéquipier libre à ≤ remise m, couloir dégagé) ; absente : l'hier au bit   // L'HOMME LIBRE (233, choosePass) : malus × (1 − liberté projetée du receveur / seuil) × visionF × axe(style) — le marqué se refuse (18 % des passes, interceptées à 27-36 %). null : le barème linéaire d'hier
