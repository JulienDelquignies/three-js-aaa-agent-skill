...
export const MATCH = {
  ...
  retournement: { rate: 4, cap: 1.75, max: 0.5, apres: 0.5 },   // max 1,2 → 0,5 (mesuré : l'attente coûtait des pertes, 447 c. 408/90 — le corps frappe à moitié tourné plutôt que de se faire prendre ; la remise du dos au jeu est la loi du 240)   // LE CORPS SE RETOURNE AVEC LE BALLON (240b, movement/rondo-sim/match-sim) : le porteur pivote à ≤ rate rad/s × accelF ; la passe à plus de cap rad dans son dos attend qu'il se retourne en conduisant vers le receveur (au plus max s ; pressé/jeté donnent) ; absente : le pivot à 540 °/s d'hier
