...
export const MATCH = {
  ...
  porteePasse: { max: 45, leve: 32 },   /* (296) LA PORTÉE EST CELLE D'UN PIED (portee.js) : tout coéquipier à ≤ max m est une option du barème, levée au-delà de leve m ; null : la portée de 13 m du rondo */ toucheCorps: null,   /* (292) LA TOUCHE SUIT LE CORPS (touche-corps.js) — RÉFUTÉE à la mesure, éteinte par défaut : opt-in { kMin: 0.5, pow: 1, vCorps: 2, vMin: 2 } — les échappées de conduite baissent d'un tiers, les pertes ne baissent pas (elles se déplacent : la défense collée) */ pokeReach: 0.5, tacleDebout: { cone: 55, k: 0.56, esq: 0.15, battu: 0.22 },   /* (291) LE TACLE DEBOUT (tacle-debout.js, Modèle 11 § 4) : le pied ne balaie que ± cone° devant le buste, réussi à la note × k (calé sur le monde : le ballon touché une fois sur deux, le book), le dribbleur esquive, le battu s'assoit battu s ; null : le pique d'hier */ // m — LE PIQUE : un ballon de conduite libre à portée de pied adverse
