...
export const MATCH = {
  ...
  passe: { d0: 0.85, dLoss: 2.8, kappa: 3.0, chiAer: 1.55, hAer: 0.6, pressT: 1.5, tClean: 0.4, dHeavy: 0.9, dHeavyMax: 2.0, tHeavyMin: 0.55, tHeavyMax: 0.8, contourne: 0.5, edgeF: 1, sigma0: 1.4, mcCourt: 0.8, mcLong: 1.3, mcCentre: 1.7, dCourt: 12, dLong: 25, kappaP: 1.2, fDist: 0.012, dRef: 12, muV: 0, muP: 0, sigV: 0.06 },
  ...
  cueillette: { marge: 1.0 },   /* (298) LA CUEILLETTE SE JUGE AU TEMPS (cueillette.js) : l'élu du ballon libre ne trotte que si l'adversaire le plus prompt arrive marge s après lui ; null : la distance + 2,5 m d'hier */ porteePasse: { max: 45, leve: 32 },   /* (296) LA PORTÉE EST CELLE D'UN PIED (portee.js) : tout coéquipier à ≤ max m est une option du barème, levée au-delà de leve m ; null : la portée de 13 m du rondo */ toucheCorps: null,   /* (292) LA TOUCHE SUIT LE CORPS (touche-corps.js) — RÉFUTÉE à la mesure, éteinte par défaut : opt-in { kMin: 0.5, pow: 1, vCorps: 2, vMin: 2 } — les échappées de conduite baissent d'un tiers, les pertes ne baissent pas (elles se déplacent : la défense collée) */ pokeReach: 0.5, tacleDebout: { cone: 55, k: 0.56, esq: 0.15, battu: 0.22 },   /* (291) LE TACLE DEBOUT (tacle-debout.js, Modèle 11 § 4) : le pied ne balaie que ± cone° devant le buste, réussi à la note × k (calé sur le monde : le ballon touché une fois sur deux, le book), le dribbleur esquive, le battu s'assoit battu s ; null : le pique d'hier */ // m — LE PIQUE : un ballon de conduite libre à portée de pied adverse
