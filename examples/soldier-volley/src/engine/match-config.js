...
export const MATCH = {
  ...
  attention: null,   // LE LAPS D'ATTENTION (246b, match-sim, bloc défensif) : { tenue: 3, taux: 1, bruit: 8 } — le distrait (concF < 1) perd son poste une tranche sur (1 − concF) × taux — REJETÉ (24 × 300 s : concentration 10 concède 10 tirs c. 17 sans note — un marqueur déplacé de 8 m n'est pas un distrait, c'est un autre placement ; le laps doit porter sur la RÉACTION, 246c) ; null : concF n'est lu nulle part
