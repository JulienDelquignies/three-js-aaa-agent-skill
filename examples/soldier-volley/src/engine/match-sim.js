...
function assignMatchJobs(st, cfg) {
  ...
  boxCrashStep(st, cfg, { busy, tac, axe, role, d2 }); contreZonesStep(st, cfg, { tac, axe, role }); suiviAppelStep(st, cfg, { tac, axe, busy });   /* (317) l'appel en profondeur est pris — suivi-appel.js */   // 242 : les trois zones d'entrée en contre (phases.js) ; 123/182b : la géométrie du centre remplit la boîte ET les corps ATTAQUENT le vol (phases.js)
